...
public abstract class AbstractFtpSessionFactory <T extends FTPClient> implements SessionFactory<FTPFile,FTPClient>{
	...
	public Session<FTPFile,FTPClient> getSession() {
		try {
	...
	private T createClient() throws SocketException, IOException { 
		...
		if (!FTPReply.isPositiveCompletion(client.getReplyCode())) {
			throw new FileHandleException("Connecting to server [" +
